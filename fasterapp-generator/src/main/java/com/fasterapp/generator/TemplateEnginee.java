...
import freemarker.template.Template;s
...
public class TemplateEnginee {
    public static void generate(Project project, ClassMetaData classMetaData) throws Exception{
        ...
        String[] fileNames = new String[]{"apis\\{0}Api.java","mappers\\{0}Mapper.java","services\\I{0}Service.java","services\\impl\\{0}ServiceImpl.java","mappers\\{0}Mapper.xml","scripts\\{0}.sql"};
